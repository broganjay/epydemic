...
class InteractionMatrix:
    ...
    def __init__(self, rows, columns, fieldValue = 1):
        ...
        self._matrix = [[fieldValue for i in range(len(columns))] for j in range(len(rows))]
    ...
    def generateEdgewiseInteractionMatrixForTwoModels(m1, m2, fieldValue = 1):
        ...
        return InteractionMatrix.generateEdgewiseInteractionMatrixForCompartments(m1.compartments(), m2.compartments(), fieldValue)
    ...
    @staticmethod
    def generateInfectionPreconditionInteractionMatrixForTwoModels(m1, m2, susceptibleD1Compartments, infectedD2Compartments):
        mat = InteractionMatrix.generateEdgewiseInteractionMatrixForTwoModels(m1, m2)
    ...
    @staticmethod
    def generateNodewiseInfectionPreconditionInteractionMatrixForTwoModels(m1, m2, susceptibleD1Compartments, infectedD2Compartments):
    ...
    @staticmethod
    def generateNodewiseInfectionEnablerInteractionMatrixForTwoModels(m1, m2, uninfected):
        mat = InteractionMatrix.generateNodewiseInteractionMatrixForTwoModels(m1, m2, 1)
        for c in uninfected:
